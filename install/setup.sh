...
folder=/afs/cern.ch/work/m/aandriat/public/MIT-FCCee # Full path of the MIT-FCCee folder
src=/afs/cern.ch/user/m/aandriat/CMSSW_7_6_3_patch2/src # Full path of the src folder in your CMSSW directory 
