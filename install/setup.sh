...
folder=/afs/cern.ch/work/a/mbaldwin/public/MIT-FCCee # Full path of the MIT-FCCee folder
src=/afs/cern.ch/user/a/mbaldwin/CMSSW_7_6_3_patch2/src # Full path of the src folder in your CMSSW directory 
